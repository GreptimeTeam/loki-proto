...
pub struct Summary {
    ...
    #[prost(double, tag = "6")]
    pub queue_time: f64,
    /// Subqueries exists for backwards compatibility reasons and is deprecated. Do
    /// not use. Instead use splits and shards
    #[prost(int64, tag = "7")]
    pub subqueries: i64,
...
pub struct Chunk {
    ...
    /// Total bytes processed for metadata but was already in memory. (found in the
    /// headchunk)
    #[prost(int64, tag = "11")]
